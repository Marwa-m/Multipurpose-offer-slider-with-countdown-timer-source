...
{
    public class DailyOffersPlugin : BasePlugin, IAdminMenuPlugin, IWidgetPlugin
    {
        ...
        public DailyOffersPlugin( IPermissionService permissionService,
        ...
        {           
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Manage", "Manage offers");
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.HideOnMobile", "Hide On Mobile");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.HideSeconds", "Hide Seconds");

            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.PrimaryColor", "Primary Color");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.BackgroundColor", "Background Color");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.PriceButtonBorderColor", "Price, Button, Border Color");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.BackgroundNumberBox", "Background of Number Box");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.CounterWordsOldPriceColor", "counter words, Old Price Color");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.CounterNumbersColor", "Color of number box");

            #endregion

            #region LRurlRecord
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.DailyOffers.offer.UrlRecords", "SEOs");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.DailyOffers.UrlRecord.AddNew", "Add New SEO");

            #endregion
            //For trial Version
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Widgets.DailyOffers.trialEnd", "Trial version has ended");

            if (_settings.GetSetting("DailyOffersdtv43") == null)
                _settings.SetSetting<DateTime>("DailyOffersdtv43", DateTime.Now);
            base.Install();
        }
        ...
        public override void Uninstall()
        {
            ...
            _localizationService.DeletePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.HideOnMobile");
            _localizationService.DeletePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.HideSeconds");
            _localizationService.DeletePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.PrimaryColor");
            _localizationService.DeletePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.BackgroundColor");
            _localizationService.DeletePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.PriceButtonBorderColor");
            _localizationService.DeletePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.BackgroundNumberBox");
            _localizationService.DeletePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.CounterWordsOldPriceColor");
            _localizationService.DeletePluginLocaleResource("Plugins.Widgets.DailyOffers.Offer.Fields.CounterNumbersColor");


            #endregion
            _localizationService.DeletePluginLocaleResource("Plugins.Widgets.DailyOffers.offer.UrlRecords");
            _localizationService.DeletePluginLocaleResource("Plugins.Widgets.DailyOffers.UrlRecord.AddNew");
        ...
        public virtual void InstallPermissions()
        {
            ...
            var permissionProviders = new List<Type> { typeof(DailyOffersPermissionProvider) };
